...
class UserViewModel {
    ...
    func fetchUser() {
        userService.fetchUser { [weak self]result in
            ...
            case .failure:
            let imageUrlString = "https://cdn1.iconfinder.com/data/icons/user-fill-icons-set/144/User003_Error-1024 .jpg"
                self?.output?.updateView(imageUrl: imageUrlString, email: "No User Found")
            }
        }
    }
}
